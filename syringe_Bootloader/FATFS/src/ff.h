...
FRESULT f_read (FIL* fp, void* buff, unsigned int btr, UINT* br);			/* Read data from a file */
FRESULT f_write (FIL* fp, const void* buff, unsigned int btw, UINT* bw);	/* Write data to a file */
