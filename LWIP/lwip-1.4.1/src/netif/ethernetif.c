...
static err_t low_level_init(struct netif *netif)
{
	...
	netif->hwaddr[0]=Sys_RT_Status.RT_IOT_Status.Ethernet_Status.mac[0]; 
	netif->hwaddr[1]=Sys_RT_Status.RT_IOT_Status.Ethernet_Status.mac[1]; 
	netif->hwaddr[2]=Sys_RT_Status.RT_IOT_Status.Ethernet_Status.mac[2];
	netif->hwaddr[3]=Sys_RT_Status.RT_IOT_Status.Ethernet_Status.mac[3];
	netif->hwaddr[4]=Sys_RT_Status.RT_IOT_Status.Ethernet_Status.mac[4];
	netif->hwaddr[5]=Sys_RT_Status.RT_IOT_Status.Ethernet_Status.mac[5];
